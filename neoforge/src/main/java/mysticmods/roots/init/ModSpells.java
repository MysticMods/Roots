...
public class ModSpells {
  ...
  public static final PropertyHolder<Property.DoubleProperty> LIFE_DRAIN_DISTANCE = P.recordProperty("life_drain/distance", Property.ofDouble(3.0, "The first value used when calculating the vector from the caster."));
  public static final PropertyHolder<Property.DoubleProperty> LIFE_DRAIN_BOUNDS = P.recordProperty("life_drain/bounds", Property.ofDouble(2.0, "The second value used when calculating the size of the bounding box from the caster's look vector."));
