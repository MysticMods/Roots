...
public class RootsDataProviderTypes {
  ...
  public static final ProviderType<CompatTagsProvider<SpellModifier>> MODIFIER_TAGS = ProviderType.register("tags/modifiers", type -> (p, e) -> new CompatTagsProvider<>(p, type, "modifiers", e.getGenerator(), RootsRegistries.MODIFIER_REGISTRY.get(), e.getExistingFileHelper()));
