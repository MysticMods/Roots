...
public interface Unlock<T> {
  ...
  record ModifierUnlock(Holder<SpellModifier> value) implements Unlock<SpellModifier> {
    ...
    public static final MapCodec<ModifierUnlock> CODEC = RootsRegistries.SPELL_MODIFIERS.holderByNameCodec().fieldOf("value").xmap(ModifierUnlock::new, ModifierUnlock::value);
