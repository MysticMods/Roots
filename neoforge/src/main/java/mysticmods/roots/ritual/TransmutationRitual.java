...
public class TransmutationRitual extends Ritual {
  ...
  protected RitualProperty<Integer> getDurationProperty() {
    return ModRituals.TRANSMUTATION_DURATION.get();
  }

  @Override
  protected RitualProperty<Integer> getRadiusXZProperty() {
    return ModRituals.TRANSMUTATION_RADIUS_XZ.get();
  }

  @Override
  protected RitualProperty<Integer> getRadiusYProperty() {
    return ModRituals.TRANSMUTATION_RADIUS_Y.get();
  }

  @Override
  protected RitualProperty<Integer> getIntervalProperty() {
    return ModRituals.TRANSMUTATION_INTERVAL.get();
  }
}
