...
public class MessageTargetedLifeDrainFX implements IMessage {
  ...
  public MessageTargetedLifeDrainFX() {
    super();
  }

  public MessageTargetedLifeDrainFX(Vector3d start, Vector3d stop) {
    this.start = start;
    this.stop = stop;
  }

  public MessageTargetedLifeDrainFX(PlayerEntity player, Entity target) {
