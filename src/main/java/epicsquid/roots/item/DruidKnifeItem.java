...
public class DruidKnifeItem extends ItemKnifeBase {

  public DruidKnifeItem(String name, ToolMaterial material) {
    super(name, material);
    ModItems.knives.add(this);

    DispenserBlock.DISPENSE_BEHAVIOR_REGISTRY.putObject(this, KnifeDispenser.getInstance());
  }
