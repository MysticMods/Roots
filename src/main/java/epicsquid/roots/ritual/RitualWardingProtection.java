...
public class RitualWardingProtection extends RitualBase {
  ...
  public static Property.PropertyInterval PROP_INTERVAL = new Property.PropertyInterval(20).setDescription("interval in ticks between each time you get provided an nondetection effect");
  public static Property<Integer> PROP_INVULN_DURATION = new Property<>("invuln_duration", 22).setDescription("duration in TICKS of the nondetection effect");
