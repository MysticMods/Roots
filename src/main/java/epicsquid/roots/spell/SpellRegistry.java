...
public class SpellRegistry {
  ...
  public static void init() {
    ...
    spellRegistry
        .put("spell_dandelion_winds", spell_dandelion_winds = new SpellDandelionWinds("spell_dandelion_winds").addCost(ModItems.moonglow_leaf, 0.125f));
    ...
    spellRegistry.put("spell_petal_shell",
        spell_petal_shell = new SpellPetalShell("spell_petal_shell").addCost(ModItems.aubergine_seed, 0.5f).addCost(ModItems.moonglow_leaf, 0.25f));
    ...
    spellRegistry.put("spell_mind_ward",
        spell_mind_ward = new SpellMindWard("spell_mind_ward").addCost(ModItems.aubergine_seed, 0.25f).addCost(ModItems.terra_moss, 0.25f));
