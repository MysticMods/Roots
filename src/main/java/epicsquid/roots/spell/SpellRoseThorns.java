...
public class SpellRoseThorns extends SpellBase {
  ...
  public static Property<Float> PROP_KNOCKBACK = new Property<>("knockback", 2.5f).setDescription("how much entities should be knocked back by");
  ...
  public static Property<Float> PROP_KNOCKUP = new Property<>("knock_up", 2.5f).setDescription("how much a creature should be knocked up by");
