...
public class SpellDisarm extends SpellBase {
  ...
  public static Modifier FLOWERS = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "flower_child"), ModifierCores.CLOUD_BERRY, Cost.of(Cost.cost(CostType.ADDITIONAL_COST, ModifierCores.CLOUD_BERRY, 0.125), Cost.cost(CostType.ALL_COST_MULTIPLIER, -0.15))));
