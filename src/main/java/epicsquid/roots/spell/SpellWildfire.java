...
public class SpellWildfire extends SpellBase {
  ...
  public static Modifier PEACEFUL = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "peaceful_flame"), ModifierCores.WILDEWHEET, ModifierCost.of(CostType.ADDITIONAL_COST, ModifierCores.WILDEWHEET, 0.125)));
  ...
  public SpellWildfire(ResourceLocation name) {
    ...
    acceptsModifiers(PERESKIA, PEACEFUL, WILDROOT, MOONGLOW_LEAF, SPIRIT_HERB, TERRA_MOSS, BAFFLE_CAP, CLOUD_BERRY, STALICRIPE, DEWGONIA);
  }
