...
public class SpellShatter extends SpellBase {
  ...
  public static Property<Integer> PROP_DEFAULT_HEIGHT = new Property<>("default_height", 0).setDescription("the default height (when not amplified: this is 2 thaumcraft.blocks tall, with the block below the block targeted also being broken; if this value is greater than 0, than the height will be 1 block above and 1 block below, relatively, th block hit)");
  ...
  public static Property<Integer> PROP_WIDTH = new Property<>("width", 1).setDescription("the width when the width modifier is applied; this is appiled to the left and right of the targeted block, meaning a width of 1 is a total width of 3 thaumcraft.blocks");
  ...
  public static Property<Integer> PROP_DEPTH = new Property<>("depth", 2).setDescription("this value is applied by offsetting the position relative to the angle the beam struck it; if struck from above, it digs down, etc. By default, with a value single 2, this should result in 3 thaumcraft.blocks being broken.");
