...
public class SpellShatter extends SpellBase {
  ...
  public static Modifier VOID = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "shatter_void"), ModifierCores.BAFFLE_CAP, Cost.of(Cost.cost(CostType.ADDITIONAL_COST, ModifierCores.BAFFLE_CAP, 0.125), Cost.cost(CostType.ALL_COST_MULTIPLIER, -0.345))));
