...
public class SpellHarvest extends SpellBase {
  ...
  public static Modifier NIGHT = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "midnight_harvest"), ModifierCores.MOONGLOW_LEAF, ModifierCost.of(CostType.ADDITIONAL_COST, ModifierCores.MOONGLOW_LEAF, 1)));
  ...
  public static Modifier BLOCKS = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "block_harvest"), ModifierCores.DEWGONIA, ModifierCost.of(CostType.ADDITIONAL_COST, ModifierCores.DEWGONIA, 1)));
  ...
  public SpellHarvest(ResourceLocation name) {
    ...
    acceptsModifiers(RADIUS1, MAGNETISM, NIGHT, UNDEAD, SMALL_RADIUS, POISON, GROWTH, COOKING, CRUSHING, BLOCKS);
  }
