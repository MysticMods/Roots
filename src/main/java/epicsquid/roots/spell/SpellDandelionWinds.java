...
public class SpellDandelionWinds extends SpellBase {
  ...
  public SpellDandelionWinds(ResourceLocation name) {
    ...
    properties.add(PROP_COOLDOWN, PROP_CAST_TYPE, PROP_COST_1, PROP_DISTANCE, PROP_RANGE_1, PROP_RANGE_2, PROP_ADDITIONAL_DISTANCE, PROP_ADDITIONAL_FALL, PROP_SLOW_DURATION, PROP_POISON_AMPLIFIER, PROP_POISON_DURATION, PROP_FIRE_DURATION);
