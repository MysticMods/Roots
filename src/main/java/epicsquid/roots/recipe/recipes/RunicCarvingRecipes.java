...
public class RunicCarvingRecipes {
  ...
  public static void initRecipes() {
    ...
    ModRecipes.addRunicCarvingRecipe(new RunicCarvingRecipe(ModBlocks.wildwoodLog.getDefaultState(), epicsquid.roots.init.ModBlocks.overgrowth_rune.getDefaultState(), HerbRegistry.getHerbByName("terra_moss"), "overgrowth_rune"));
  }
}
