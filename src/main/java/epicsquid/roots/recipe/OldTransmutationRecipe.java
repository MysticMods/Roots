...
public class OldTransmutationRecipe extends RegistryItem {
  ...
  public OldTransmutationRecipe(ResourceLocation name, Block startBlock, ItemStack endState, WorldPosStatePredicate condition) {
  ...
  public OldTransmutationRecipe(ResourceLocation name, Block startBlock, IBlockState endState, WorldPosStatePredicate condition) {
    this.setRegistryName(name);
    this.startBlock = startBlock;
  ...
  public OldTransmutationRecipe(ResourceLocation name, IBlockState startState, IBlockState endState, WorldPosStatePredicate condition) {
    this.setRegistryName(name);
  ...
  public OldTransmutationRecipe(ResourceLocation name, IBlockState startState, ItemStack endState, WorldPosStatePredicate condition) {
    this.setRegistryName(name);
    this.startBlock = null;
    this.startState = startState;
    this.endStack = endState;
