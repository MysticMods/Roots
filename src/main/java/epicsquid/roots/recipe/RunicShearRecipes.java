...
public class RunicShearRecipes {
  ...
  public static void initRecipes() {
    ModRecipes.addRunicShearRecipe(new RunicShearRecipe(new ResourceLocation(Roots.MODID, "wildewheet"), new PropertyPredicate(net.minecraft.block.Blocks.WHEAT.getDefaultState().withProperty(CropsBlock.AGE, 7), CropsBlock.AGE), Blocks.WHEAT.getDefaultState().withProperty(CropsBlock.AGE, 0), new ItemStack(ModItems.wildewheet), new ItemStack(Items.WHEAT)));
/*    ModRecipes.addRunicShearRecipe(new RunicShearRecipe(new ResourceLocation(Roots.MODID, "aubergine"), new PropertyPredicate(Blocks.CARROTS.getDefaultState().withProperty(BlockCrops.AGE, 7), BlockCrops.AGE), Blocks.CARROTS.getDefaultState().withProperty(BlockCrops.AGE, 0), new ItemStack(epicsquid.mysticalworld.init.ModItems.aubergine), new ItemStack(Items.CARROT)));*/
    ModRecipes.addRunicShearRecipe(new RunicShearRecipe(new ResourceLocation(Roots.MODID, "spirit_herb"), new PropertyPredicate(net.minecraft.block.Blocks.BEETROOTS.getDefaultState().withProperty(BeetrootBlock.BEETROOT_AGE, 3), BeetrootBlock.BEETROOT_AGE), Blocks.BEETROOTS.getDefaultState().withProperty(BeetrootBlock.BEETROOT_AGE, 0), new ItemStack(ModItems.spirit_herb), new ItemStack(Items.BEETROOT)));
