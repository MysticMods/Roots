...
public class BaseModifiers {
  ...
  public static Modifier EMPOWER = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "empower"), ModifierCores.GUNPOWDER, Cost.single(CostType.ALL_COST_MULTIPLIER, 0.10))); // Additionally increases the duration or damage of the spell if applicable
  ...
  public static Modifier GREATER_EMPOWER = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "greater_empower"), ModifierCores.BLAZE_POWDER, Cost.single(CostType.ALL_COST_MULTIPLIER, 0.05))); // Increases duration or damage of the spell if applicable.
