...
public class BaseModifiers {
  public static Modifier SPEEDY = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "speedy"), ModifierType.ALL_COST_MULTIPLIER, ModifierCores.REDSTONE, 0.05)); // Decreases the cooldown or interval of the spell
  ...
  public static Modifier GREATER_SPEEDY = ModifierRegistry.register(new Modifier(new ResourceLocation(Roots.MODID, "greater_speedy"), ModifierType.ALL_COST_MULTIPLIER, ModifierCores.RUNIC_DUST, 0.10)); // Decreases the cooldown or interval of the spell again
