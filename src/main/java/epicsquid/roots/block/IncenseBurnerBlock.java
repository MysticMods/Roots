...
public class IncenseBurnerBlock extends BlockTEBase {

  public IncenseBurnerBlock(@Nonnull Material mat, @Nonnull SoundType type, float hardness, @Nonnull String name, @Nonnull Class<? extends TileEntity> teClass) {
