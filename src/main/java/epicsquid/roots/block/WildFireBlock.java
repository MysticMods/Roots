...
public class WildFireBlock extends FireBlock implements IBlock, IModeledObject, ICustomModeledObject, INoCullBlock {
  public @Nonnull
  String name;

  public WildFireBlock(@Nonnull String name) {
    super();
    this.name = name;
