...
public class ModBlocks {
  ...
  public static void registerBlocks(@Nonnull RegisterContentEvent event) {
    ...
    event.addBlock(trample_rune = new BlockTrample(Material.IRON, SoundType.METAL, 1.4f, "runestone_trample", TileEntityTrample.class).setModelCustom(true)).setCreativeTab(Roots.tab);

    event.addBlock(wildwood_leaves = new BlockLeavesBase(0.8f, "wildwood_leaves", () -> new ItemStack(ModItems.wildroot), 50).setFlammable(true).setModelCustom(true).setOpacity(false).setCreativeTab(Roots.tab));
