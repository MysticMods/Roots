...
public class ModParticles {
	...
	public static Class<? extends ParticleBase> PARTICLE_PETAL, PARTICLE_STAR, PARTICLE_LINE_GLOW, PARTICLE_THORN, PARTICLE_LINE_GLOW_STEADY, PARTICLE_STAR_NO_GRAVITY, PARTICLE_PYRE_LEAF, PARTICLE_PETAL_NO_DEPTH, PARTICLE_WHIRLWIND_LEAF;
	...
	public static void init() {
		...
		PARTICLE_PETAL_NO_DEPTH = ParticleRegistry.registerParticle(MysticalLib.MODID, ParticlePetalNoDepth.class, new ResourceLocation("roots:particle/particle_petal"));
		PARTICLE_PYRE_LEAF = ParticleRegistry.registerParticle(MysticalLib.MODID, ParticlePyreLeaf.class, LibRegistry.LEAF_TEXTURES);
		PARTICLE_WHIRLWIND_LEAF = ParticleRegistry.registerParticle(MysticalLib.MODID, ParticleWhirlwindLeaf.class, LibRegistry.LEAF_TEXTURES);
