...
public class CTMortarRecipe extends MortarRecipe {
  ...
  public CTMortarRecipe(ItemStack result, List<IIngredient> ingredients) {
  ...
  public CTMortarRecipe(ItemStack result, List<IIngredient> ingredients, float red1, float green1, float blue1, float red2, float green2, float blue2) {
