...
public class ParticlePetalNoDepth extends ParticleBase {
	...
	public ParticlePetalNoDepth(World world, double x, double y, double z, double vx, double vy, double vz, double[] data) {
