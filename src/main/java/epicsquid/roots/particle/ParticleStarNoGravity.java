...
public class ParticleStarNoGravity extends ParticleBase {
	...
	public ParticleStarNoGravity(World world, double x, double y, double z, double vx, double vy, double vz, double[] data) {
