...
public class Growth {
  ...
  static {
    ...
    addBlacklist(net.minecraft.block.Blocks.TALLGRASS, Blocks.DOUBLE_PLANT, net.minecraft.block.Blocks.GRASS, net.minecraft.block.Blocks.DOUBLE_PLANT, Blocks.RED_FLOWER, net.minecraft.block.Blocks.YELLOW_FLOWER);
  }
  ...
  public static boolean canGrow(World world, BlockPos pos, BlockState state) {
    ...
    if (state.getBlock() == net.minecraft.block.Blocks.REEDS || state.getBlock() == net.minecraft.block.Blocks.CACTUS) {
