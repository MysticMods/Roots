...
public class BlockMushroomBase extends MushroomBlock implements IBlock, IModeledObject {
  ...
  @Override
  public boolean generateBigMushroom(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull Random rand) {
