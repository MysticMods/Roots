...
public class MagnetismParticle extends TextureSheetParticle {
  ...
  protected MagnetismParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int c1, int c2) {
  ...
  public record Provider(SpriteSet sprite) implements ParticleProvider<RootsParticleOptions> {
    ...
    public Particle createParticle(RootsParticleOptions type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
      var particle = new MagnetismParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, type.color1(), type.color2());
