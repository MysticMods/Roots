...
public class JerboaEntity extends Animal {

  public JerboaEntity(EntityType<? extends JerboaEntity> type, Level world) {
    super(type, world);
  ...
  public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pEntity) {
    return ModEntities.JERBOA.get().create(pLevel);
  }
  ...
  protected void registerGoals() {
    ...
    goalSelector.addGoal(3, new TemptGoal(this, 1.25D, Ingredient.of(RootsTags.Items.JERBOA_FOOD), false));
...
/*    if (random.nextInt(15) == 0) {
  ...
  public boolean isFood(ItemStack arg) {
    return arg.is(RootsTags.Items.JERBOA_FOOD);
  }
