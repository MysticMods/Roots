        ...
        (DataProvider.Factory<DatapackBuiltinEntriesProvider>) output -> new DatapackBuiltinEntriesProvider(
            ...
            new RegistrySetBuilder()
                ...
                .add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, bootstrap -> {
                  ...
                  bootstrap.register(ModFeatures.WILD_ROOTS_FOREST_KEY, new BiomeModifiers.AddFeaturesBiomeModifier(biomeGetter.getOrThrow(RootsTags.Biomes.WILD_ROOTS_FOREST_BIOMES), HolderSet.direct(placedGetter.getOrThrow(ModFeatures.PLACED_WILD_ROOTS_FOREST_KEY)), GenerationStep.Decoration.VEGETAL_DECORATION));
