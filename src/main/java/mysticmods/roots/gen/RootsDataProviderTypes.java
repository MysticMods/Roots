...
public class RootsDataProviderTypes {
  ...
  public static final ProviderType<CompatTagsProvider<Grove>> GROVE_TAGS = ProviderType.register("tags/groves", type -> (p, e) -> new CompatTagsProvider<>(p, type, "groves", e.getGenerator(), Registries.GROVE_REGISTRY.get(), e.getExistingFileHelper()));
