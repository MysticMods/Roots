...
public final class RootsGroveTagsProvider extends IntrinsicHolderTagsProvider<Grove> {
  ...
  protected void addTags(HolderLookup.Provider provider) {
    ...
    tag(RootsTags.Groves.ANY).addTags(RootsTags.Groves.FAIRY, RootsTags.Groves.ELEMENTAL, RootsTags.Groves.PRIMAL, RootsTags.Groves.TWILIGHT, RootsTags.Groves.SPROUTING, RootsTags.Groves.FUNGAL);
  }
