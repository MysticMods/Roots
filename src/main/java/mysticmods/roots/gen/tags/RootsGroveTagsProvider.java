...
public final class RootsGroveTagsProvider extends IntrinsicHolderTagsProvider<Grove> {
  ...
  public RootsGroveTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, @org.jetbrains.annotations.Nullable net.neoforged.neoforge.common.data.ExistingFileHelper existingFileHelper) {
  ...
  protected void addTags(HolderLookup.Provider provider) {
    ...
    tag(RootsTags.Groves.ANY).addTags(RootsTags.Groves.FAIRY, RootsTags.Groves.ELEMENTAL, RootsTags.Groves.PRIMAL, RootsTags.Groves.TWILIGHT, RootsTags.Groves.CULTIVATION, RootsTags.Groves.FUNGAL);
  }
