...
public final class RootsSpellTagsProvider extends IntrinsicHolderTagsProvider<Spell> {
  ...
  public RootsSpellTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, @org.jetbrains.annotations.Nullable net.neoforged.neoforge.common.data.ExistingFileHelper existingFileHelper) {
