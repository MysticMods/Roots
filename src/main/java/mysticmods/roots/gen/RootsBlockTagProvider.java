...
public class RootsBlockTagProvider extends BlockTagsProvider {
  ...
  protected void addTags(HolderLookup.Provider provider) {
    ...
    // HOE
    this.tag(BlockTags.MINEABLE_WITH_HOE).add(THATCH.get(), STONEPETAL.get(), WILDWOOD_LEAVES.get(), WILD_ROOTS.get(), CREEPING_GROVE_MOSS.get(), HANGING_GROVE_MOSS.get(), BAFFLECAP_BLOCK.get(), BAFFLECAP.get());
    // PICKAXE
    this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(RUNESTONE.get(), RUNESTONE_BRICK.get(), CHISELED_RUNESTONE.get(), MOSSY_RUNESTONE.get(), RUNESTONE_TILE.get(), CHISELED_RUNED_OBSIDIAN.get(), RUNED_BRICK.get(), RUNED_TILE.get(), SILVER_ORE.get(), DEEPSLATE_SILVER_ORE.get(), GRANITE_QUARTZ_ORE.get(), RAW_SILVER_BLOCK.get(), SILVER_BLOCK.get(), RUNESTONE_STAIRS.get(), RUNESTONE_BRICK_STAIRS.get(), RUNESTONE_TILE_STAIRS.get(), MOSSY_RUNESTONE_STAIRS.get(), RUNED_STAIRS.get(), RUNED_TILE_STAIRS.get(), RUNED_BRICK_STAIRS.get(), RUNED_SLAB.get(), RUNED_BRICK_SLAB.get(), RUNED_TILE_SLAB.get(), RUNESTONE_SLAB.get(), RUNESTONE_BRICK_SLAB.get(), RUNESTONE_TILE_SLAB.get(), MOSSY_RUNESTONE_SLAB.get(), RUNED_BUTTON.get(), RUNED_TILE_BUTTON.get(), RUNED_BRICK_BUTTON.get(), RUNESTONE_BUTTON.get(), RUNESTONE_BRICK_BUTTON.get(), RUNESTONE_TILE_BUTTON.get(), RUNED_PRESSURE_PLATE.get(), RUNED_TILE_PRESSURE_PLATE.get(), RUNED_BRICK_PRESSURE_PLATE.get(), RUNESTONE_PRESSURE_PLATE.get(), RUNESTONE_BRICK_PRESSURE_PLATE.get(), RUNESTONE_TILE_PRESSURE_PLATE.get(), RUNED_WALL.get(), RUNED_BRICK_WALL.get(), RUNED_TILE_WALL.get(), RUNED_OBSIDIAN.get(), CHISELED_RUNED_OBSIDIAN.get(), RUNESTONE_WALL.get(), RUNESTONE_BRICK_WALL.get(), RUNESTONE_TILE_WALL.get(), MOSSY_RUNESTONE_WALL.get(), PRIMAL_GROVE_STONE.get(), INCENSE_BURNER.get(), MORTAR.get(), UNENDING_BOWL.get());
    // AXE
    this.tag(BlockTags.MINEABLE_WITH_AXE).add(WILDWOOD_LOG.get(), STRIPPED_WILDWOOD_LOG.get(), STRIPPED_WILDWOOD_WOOD.get(), WILDWOOD_WOOD.get(), RUNED_WILDWOOD_LOG.get(), RUNED_ACACIA_LOG.get(), RUNED_BIRCH_LOG.get(), RUNED_JUNGLE_LOG.get(), RUNED_OAK_LOG.get(), RUNED_DARK_OAK_LOG.get(), RUNED_CRIMSON_STEM.get(), RUNED_WARPED_STEM.get(), WILDWOOD_PLANKS.get(), RUNED_MANGROVE_LOG.get(), RUNED_SPRUCE_LOG.get(), WILDWOOD_STAIRS.get(), WILDWOOD_SLAB.get(), WILDWOOD_FENCE.get(), WILDWOOD_GATE.get(), WILDWOOD_BUTTON.get(), WILDWOOD_PRESSURE_PLATE.get(), WILDWOOD_DOOR.get(), WILDWOOD_TRAPDOOR.get(), PYRE.get(), REINFORCED_PYRE.get(), DECORATIVE_PYRE.get());
    this.tag(BlockTags.SLABS).add(RUNED_SLAB.get(), RUNED_BRICK_SLAB.get(), RUNED_TILE_SLAB.get(), RUNESTONE_SLAB.get(), RUNESTONE_BRICK_SLAB.get(), RUNESTONE_TILE_SLAB.get(), MOSSY_RUNESTONE_SLAB.get(), WILDWOOD_BUTTON.get());
    this.tag(BlockTags.WOODEN_SLABS).add(WILDWOOD_SLAB.get());
    this.tag(BlockTags.WOODEN_STAIRS).add(WILDWOOD_STAIRS.get());
    this.tag(BlockTags.STAIRS).add(RUNESTONE_STAIRS.get(), RUNESTONE_BRICK_STAIRS.get(), RUNESTONE_TILE_STAIRS.get(), MOSSY_RUNESTONE_STAIRS.get(), RUNED_STAIRS.get(), RUNED_TILE_STAIRS.get(), RUNED_BRICK_STAIRS.get());

    this.tag(BlockTags.UNSTABLE_BOTTOM_CENTER).add(WILDWOOD_GATE.get());

    this.tag(BlockTags.WALLS).add(RUNED_WALL.get(), RUNED_BRICK_WALL.get(), RUNED_TILE_WALL.get(), RUNESTONE_WALL.get(), RUNESTONE_BRICK_WALL.get(), RUNESTONE_TILE_WALL.get(), MOSSY_RUNESTONE_WALL.get());
    ...
    this.tag(BlockTags.BUTTONS).add(RUNED_BUTTON.get(), RUNED_TILE_BUTTON.get(), RUNED_BRICK_BUTTON.get(), RUNESTONE_BUTTON.get(), RUNESTONE_BRICK_BUTTON.get(), RUNESTONE_TILE_BUTTON.get());
    this.tag(BlockTags.WOODEN_BUTTONS).add(WILDWOOD_BUTTON.get());
    this.tag(BlockTags.STONE_PRESSURE_PLATES).add(RUNED_PRESSURE_PLATE.get(), RUNED_TILE_PRESSURE_PLATE.get(), RUNED_BRICK_PRESSURE_PLATE.get(), RUNESTONE_PRESSURE_PLATE.get(), RUNESTONE_BRICK_PRESSURE_PLATE.get(), RUNESTONE_TILE_PRESSURE_PLATE.get());
    ...
    this.tag(RootsTags.Blocks.WILDWOOD_LOGS).add(WILDWOOD_LOG.get(), STRIPPED_WILDWOOD_LOG.get(), STRIPPED_WILDWOOD_WOOD.get(), WILDWOOD_WOOD.get(), RUNED_WILDWOOD_LOG.get());
    ...
    this.tag(RootsTags.Blocks.RUNED_OBSIDIAN).add(RUNED_OBSIDIAN.get(), CHISELED_RUNED_OBSIDIAN.get(), RUNED_BRICK.get(), RUNED_TILE.get());
    ...
    this.tag(RootsTags.Blocks.RUNESTONE).add(RUNESTONE.get(), RUNESTONE_BRICK.get(), CHISELED_RUNESTONE.get(), MOSSY_RUNESTONE.get());
    this.tag(RootsTags.Blocks.RUNE_CAPSTONES).add(CHISELED_RUNESTONE.get());
    this.tag(RootsTags.Blocks.RUNE_PILLARS).add(RUNESTONE.get(), RUNESTONE_BRICK.get(), MOSSY_RUNESTONE.get(), RUNESTONE_TILE.get());
    ...
    this.tag(RootsTags.Blocks.PYRES).add(PYRE.get(), REINFORCED_PYRE.get(), DECORATIVE_PYRE.get());
    ...
    //noinspection unchecked
    this.tag(RootsTags.Blocks.ELEMENTAL_CROPS).addTags(RootsTags.Blocks.AIR_CROPS, RootsTags.Blocks.EARTH_CROPS, RootsTags.Blocks.FIRE_CROPS, RootsTags.Blocks.WATER_CROPS);

    //noinspection unchecked
    this.tag(RootsTags.Blocks.CROPS).addTags(RootsTags.Blocks.ELEMENTAL_CROPS, RootsTags.Blocks.WILDEWHEET_CROP, RootsTags.Blocks.WILDROOT_CROP, RootsTags.Blocks.MOONGLOW_CROP, RootsTags.Blocks.PERESKIA_CROP, RootsTags.Blocks.SPIRITLEAF_CROP);
