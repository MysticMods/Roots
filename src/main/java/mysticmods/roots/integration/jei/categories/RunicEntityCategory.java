...
public class RunicEntityCategory extends RootsRecipeBaseCategory<KnifeRecipe> {
  ...
  public void draw(KnifeRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    if (recipe == DynamicBarkRecipe.INSTANCE) {
      ...
      if (recipe.getStateMapper() != null) {
        ...
        RenderUtil.renderBlock(guiGraphics, input, 35.5f, 32.5f, 0, 45, 12f);
        RenderUtil.renderBlock(guiGraphics, output, 102.5f, 32.5f, 0, 45, 12f);
      }
    }
  }
}
