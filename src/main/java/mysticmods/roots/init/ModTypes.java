...
public class ModTypes {
  public static final BlockSetType RUNESTONE_SET = BlockSetType.register(new BlockSetType(RootsAPI.rl("runestone")
      .toString()));
  public static final BlockSetType RUNED_OBSIDIAN_SET = BlockSetType.register(new BlockSetType(RootsAPI.rl("runed_obsidian")
      .toString()));
