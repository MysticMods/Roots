...
public class ModModifiers {
  ...
  public static final DeferredHolder<SpellModifier, SpellModifier> ACID_CLOUD_FIRE = REGISTER.register("acid_cloud/fire", () -> new SpellModifier(CostInstance.add(ModHerbs.INFERNO_BULB, SpellCosts.BASE_0250), ModSpells.ACID_CLOUD.getKey(), SpellType.Condition.SPECIFIED));
  ...
  public static final DeferredHolder<SpellModifier, SpellModifier> ACID_CLOUD_SLOWNESS = REGISTER.register("acid_cloud/slowness", () -> new SpellModifier(CostInstance.add(ModHerbs.DEWGONIA, SpellCosts.BASE_0125), ModSpells.ACID_CLOUD.getKey(), SpellType.Condition.SPECIFIED));
  public static final DeferredHolder<SpellModifier, SpellModifier> ACID_CLOUD_TEMPORAL_MORASS = REGISTER.register("acid_cloud/temporal_morass", () -> new SpellModifier(CostInstance.add(ModHerbs.MOONGLOW, SpellCosts.BASE_0125), ModModifiers.ACID_CLOUD_SLOWNESS.getKey(), ModSpells.ACID_CLOUD.getKey(), SpellType.Condition.SPECIFIED, GroupId.NONE));
  ...
  public static final DeferredHolder<SpellModifier, SpellModifier> GROWTH_INFUSION_HYDRATION = REGISTER.register("growth_infusion/hydration", () -> new SpellModifier(CostInstance.add(ModHerbs.DEWGONIA, SpellCosts.BASE_0063), ModSpells.GROWTH_INFUSION.getKey(), SpellType.Condition.SPECIFIED));
  public static final DeferredHolder<SpellModifier, SpellModifier> GROWTH_INFUSION_FERTILIZER = REGISTER.register("growth_infusion/fertilizer", () -> new SpellModifier(CostInstance.add(ModHerbs.BAFFLECAP, SpellCosts.BASE_0500), ModModifiers.GROWTH_INFUSION_TARGETED_GROWTH.getKey(), ModSpells.GROWTH_INFUSION.getKey(), SpellType.Condition.SPECIFIED, GroupId.NONE));
