...
public class ModSpells {
  ...
  public static final PropertyHolder<Property.IntegerProperty> TEMPORARY_MORASS_AMPLIFIER = P.recordProperty("temporal_morass/amplifier", Property.ofInt(5, "The amplifier for the slowness effect applied by Temporal Morass."));
