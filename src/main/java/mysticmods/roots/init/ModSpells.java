...
public class ModSpells {
  ...
  public static final RegistryEntry<AcidCloudSpell> ACID_CLOUD = spell(Spells.ACID_CLOUD, AcidCloudSpell::new, () -> List.of(Cost.add(ModHerbs.BAFFLECAP, 0.250), Cost.add(ModHerbs.CLOUD_BERRY, 0.250)));
  ...
  public static final RegistryEntry<AquaBubbleSpell> AQUA_BUBBLE = spell(Spells.AQUA_BUBBLE, AquaBubbleSpell::new, () -> List.of(Cost.add(ModHerbs.DEWGONIA, 0.250)));
  ...
  public static final RegistryEntry<AugmentSpell> AUGMENT = spell(Spells.AUGMENT, AugmentSpell::new, () -> List.of(Cost.add(ModHerbs.GROVE_MOSS, 0.250), Cost.add(ModHerbs.INFERNO_BULB, 0.125)));
  ...
  public static final RegistryEntry<LightDrifterSpell> LIGHT_DRIFTER = spell(Spells.LIGHT_DRIFTER, LightDrifterSpell::new, () -> List.of(Cost.add(ModHerbs.MOONGLOW, 0.250)));
  ...
  public static final RegistryEntry<MagnetismSpell> MAGNETISM = spell(Spells.MAGNETISM, MagnetismSpell::new, () -> List.of(Cost.add(ModHerbs.SPIRITLEAF, 0.250)));
  ...
  public static final RegistryEntry<ChrysopoeiaSpell> CHRYSOPOEIA = spell(Spells.CHRYSOPOEIA, ChrysopoeiaSpell::new, () -> List.of(Cost.add(ModHerbs.INFERNO_BULB, 0.250), Cost.add(ModHerbs.DEWGONIA, 0.250)));
  ...
  public static final RegistryEntry<DandelionWindsSpell> DANDELION_WINDS = spell(Spells.DANDELION_WINDS, DandelionWindsSpell::new, () -> List.of(Cost.add(ModHerbs.CLOUD_BERRY, 0.250), Cost.add(ModHerbs.GROVE_MOSS, 0.125)));
  ...
  public static final RegistryEntry<DesaturateSpell> DESATURATE = spell(Spells.DESATURATE, DesaturateSpell::new, () -> List.of(Cost.add(ModHerbs.WILDEWHEET, 0.250), Cost.add(ModHerbs.GROVE_MOSS, 0.250)));
  ...
  public static final RegistryEntry<DisarmSpell> DISARM = spell(Spells.DISARM, DisarmSpell::new, () -> List.of(Cost.add(ModHerbs.SPIRITLEAF, 0.250), Cost.add(ModHerbs.BAFFLECAP, 0.250)));
  ...
  public static final RegistryEntry<ExtensionSpell> EXTENSION = spell(Spells.EXTENSION, ExtensionSpell::new, () -> List.of(Cost.add(ModHerbs.GROVE_MOSS, 0.250), Cost.add(ModHerbs.WILDROOT, 0.250)));
  ...
  public static final RegistryEntry<NondetectionSpell> NONDETECTION = spell(Spells.NONDETECTION, NondetectionSpell::new, () -> List.of(Cost.add(ModHerbs.SPIRITLEAF, 0.250), Cost.add(ModHerbs.DEWGONIA, 0.250)));
  ...
  public static final RegistryEntry<FeyLightSpell> FEY_LIGHT = spell(Spells.FEY_LIGHT, FeyLightSpell::new, () -> List.of(Cost.add(ModHerbs.GROVE_MOSS, 0.250), Cost.add(ModHerbs.PERESKIA, 0.250)));
  ...
  // Geas (80 cooldown)
  public static final RegistryEntry<GeasSpell> GEAS = spell(Spells.GEAS, GeasSpell::new, () -> List.of(Cost.add(ModHerbs.BAFFLECAP, 0.250), Cost.add(ModHerbs.GROVE_MOSS, 0.250)));
  ...
  public static final RegistryEntry<ControlUndeadSpell> CONTROL_UNDEAD = spell(Spells.CONTROL_UNDEAD, ControlUndeadSpell::new, () -> List.of(Cost.add(ModHerbs.BAFFLECAP, 0.250), Cost.add(ModHerbs.MOONGLOW, 0.250)));
  ...
  public static final RegistryEntry<GrowthInfusionSpell> GROWTH_INFUSION = spell(Spells.GROWTH_INFUSION, GrowthInfusionSpell::new, () -> List.of(Cost.add(ModHerbs.WILDEWHEET, 0.250)));
  ...
  // Harvest (25 cooldown)
  public static final RegistryEntry<HarvestSpell> HARVEST = spell(Spells.HARVEST, HarvestSpell::new, () -> List.of(Cost.add(ModHerbs.WILDEWHEET, 0.250), Cost.add(ModHerbs.STALICRIPE, 0.250)));
  ...
  public static final RegistryEntry<LifeDrainSpell> LIFE_DRAIN = spell(Spells.LIFE_DRAIN, LifeDrainSpell::new, () -> List.of(Cost.add(ModHerbs.WILDEWHEET, 0.250), Cost.add(ModHerbs.STALICRIPE, 0.250)));
  ...
  public static final RegistryEntry<PetalShellSpell> PETAL_SHELL = spell(Spells.PETAL_SHELL, PetalShellSpell::new, () -> List.of(Cost.add(ModHerbs.PERESKIA, 0.250)));
  ...
  public static final RegistryEntry<RadianceSpell> RADIANCE = spell(Spells.RADIANCE, RadianceSpell::new, () -> List.of(Cost.add(ModHerbs.INFERNO_BULB, 0.250), Cost.add(ModHerbs.CLOUD_BERRY, 0.250)));
  ...
  public static final RegistryEntry<RoseThornsSpell> ROSE_THORNS = spell(Spells.ROSE_THORNS, RoseThornsSpell::new, () -> List.of(Cost.add(ModHerbs.WILDROOT, 0.250)));
  ...
  public static final RegistryEntry<SanctuarySpell> SANCTUARY = spell(Spells.SANCTUARY, SanctuarySpell::new, () -> List.of(Cost.add(ModHerbs.PERESKIA, 0.250), Cost.add(ModHerbs.STALICRIPE, 0.250)));
  ...
  // Shatter (20 cooldown)
  public static final RegistryEntry<ShatterSpell> SHATTER = spell(Spells.SHATTER, ShatterSpell::new, () -> List.of(Cost.add(ModHerbs.STALICRIPE, 0.250)));
  ...
  // Jaunt (80 cooldown)
  public static final RegistryEntry<JauntSpell> JAUNT = spell(Spells.JAUNT, JauntSpell::new, () -> List.of(Cost.add(ModHerbs.PERESKIA, 0.250), Cost.add(ModHerbs.SPIRITLEAF, 0.250)));
  ...
  public static final RegistryEntry<StormCloudSpell> STORM_CLOUD = spell(Spells.STORM_CLOUD, StormCloudSpell::new, () -> List.of(Cost.add(ModHerbs.DEWGONIA, 0.250), Cost.add(ModHerbs.CLOUD_BERRY, 0.250)));
  ...
  public static final RegistryEntry<SkySoarerSpell> SKY_SOARER = spell(Spells.SKY_SOARER, SkySoarerSpell::new, () -> List.of(Cost.add(ModHerbs.CLOUD_BERRY, 0.250)));
  ...
  public static final RegistryEntry<TimeStopSpell> TIME_STOP = spell(Spells.TIME_STOP, TimeStopSpell::new, () -> List.of(Cost.add(ModHerbs.MOONGLOW, 0.250), Cost.add(ModHerbs.STALICRIPE, 0.250)));
  ...
  public static final RegistryEntry<WildfireSpell> WILDFIRE = spell(Spells.WILDFIRE, WildfireSpell::new, () -> List.of(Cost.add(ModHerbs.INFERNO_BULB, 0.250)));
  ...
  private static <T extends Spell> RegistryEntry<T> spell(ResourceKey<Spell> key, SpellConstructor<T> consturctor, Supplier<List<Cost>> costs) {
    return REGISTRATE.simple(key.location().getPath(), Spell.class, spellBuilder(consturctor, costs));
  }

  private static <T extends Spell> NonNullSupplier<T> spellBuilder (SpellConstructor<T> constructor, Supplier<List<Cost>> costs) {
    return () -> constructor.create(costs.get());
  }
  private interface SpellConstructor<T extends Spell> {
    T create (List<Cost> costs);
  }
