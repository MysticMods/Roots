...
public class ModSpells {
  ...
  public static final DeferredHolder<Spell, AcidCloudSpell> ACID_CLOUD = REGISTER.register(Spells.ACID_CLOUD.location()
      .getPath(), () -> new AcidCloudSpell(new Spell.Properties(Spells.ACID_CLOUD)
  ...
  public static final DeferredHolder<Spell, EmptySpell> EMPTY = REGISTER.register("empty", () -> new EmptySpell(new Spell.Properties(Spells.EMPTY)
  ...
  public static final DeferredHolder<Spell, AquaBubbleSpell> AQUA_BUBBLE = REGISTER.register(Spells.AQUA_BUBBLE.location()
      ...
      new Spell.Properties(Spells.AQUA_BUBBLE)
          .type(SpellType.Cast.INSTANT)
  ...
  public static final DeferredHolder<Spell, LightDrifterSpell> LIGHT_DRIFTER = REGISTER.register(Spells.LIGHT_DRIFTER.location()
      .getPath(), () -> new LightDrifterSpell(new Spell.Properties(Spells.LIGHT_DRIFTER)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
  ...
  public static final DeferredHolder<Spell, MagnetismSpell> MAGNETISM = REGISTER.register(Spells.MAGNETISM.location()
      .getPath(), () -> new MagnetismSpell(new Spell.Properties(Spells.MAGNETISM)
      .type(SpellType.Cast.INSTANT)
  ...
  public static final DeferredHolder<Spell, DandelionWindsSpell> DANDELION_WINDS = REGISTER.register(Spells.DANDELION_WINDS.location()
      .getPath(), () -> new DandelionWindsSpell(new Spell.Properties(Spells.DANDELION_WINDS)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
  ...
  public static final DeferredHolder<Spell, DecaySpell> DECAY = REGISTER.register(Spells.DECAY.location()
      .getPath(), () -> new DecaySpell(new Spell.Properties(Spells.DECAY)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.OPERATION)
  ...
  public static final DeferredHolder<Spell, DesaturateSpell> DESATURATE = REGISTER.register(Spells.DESATURATE.location()
      .getPath(), () -> new DesaturateSpell(new Spell.Properties(Spells.DESATURATE)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
  ...
  public static final DeferredHolder<Spell, SaturateSpell> SATURATE = REGISTER.register(Spells.SATURATE.location()
      .getPath(), () -> new SaturateSpell(new Spell.Properties(Spells.SATURATE)
      .textColor(ChatFormatting.DARK_GREEN)
  ...
  public static final DeferredHolder<Spell, DisarmSpell> DISARM = REGISTER.register(Spells.DISARM.location()
      .getPath(), () -> new DisarmSpell(new Spell.Properties(Spells.DISARM)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.OPERATION)
      .textColor(ChatFormatting.AQUA)
  ...
  public static final DeferredHolder<Spell, ExtensionSpell> EXTENSION = REGISTER.register(Spells.EXTENSION.location()
      .getPath(), () -> new ExtensionSpell(new Spell.Properties(Spells.EXTENSION)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
  ...
  public static final DeferredHolder<Spell, NondetectionSpell> NONDETECTION = REGISTER.register(Spells.NONDETECTION.location()
      .getPath(), () -> new NondetectionSpell(new Spell.Properties(Spells.NONDETECTION)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
  ...
  public static final DeferredHolder<Spell, SylvanLightSpell> SYLVAN_LIGHT = REGISTER.register(Spells.SYLVAN_LIGHT.location()
      .getPath(), () -> new SylvanLightSpell(new Spell.Properties(Spells.SYLVAN_LIGHT)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
  ...
  public static final DeferredHolder<Spell, GeasSpell> GEAS = REGISTER.register(Spells.GEAS.location()
      .getPath(), () -> new GeasSpell(new Spell.Properties(Spells.GEAS)
...
/*  public static final DeferredHolder<Spell, EnslaveUndeadSpell> SUMMON_UNDEAD = spell(Spells.SUMMON_UNDEAD, EnslaveUndeadSpell::new, ChatFormatting.DARK_GREEN, () -> CostInstance.of(Cost.add(ModHerbs.BAFFLECAP, SpellCosts.BASE_0250), Cost.add(ModHerbs.MOONGLOW, SpellCosts.BASE_0250)));
  ...
  public static final DeferredHolder<Spell, GrowthInfusionSpell> GROWTH_INFUSION = REGISTER.register(Spells.GROWTH_INFUSION.location()
      .getPath(), () ->
      new GrowthInfusionSpell(new Spell.Properties(Spells.GROWTH_INFUSION)
          .type(SpellType.Cast.CONTINUOUS)
          .charge(SpellType.Charge.INSTANCE)
          ...
          .transformer(ModModifiers.GROWTH_INFUSION_RAMPANT_GROWTH, (mod, transformer) -> transformer
              ...
              .description(mod.getOrCreateDescriptionId())
              .extended(mod.getOrCreateTooltipExtendedDescriptionId())
              .tooltip(mod.getOrCreateTooltipDescriptionId())
              .component(mod::getOrCreateDescriptionComponents)
          )
          ...
          .properties(ModSpells.GROWTH_INFUSION_RAMPANT_GROWTH_INTERVAL, ModSpells.GROWTH_INFUSION_RAMPANT_GROWTH_COUNT, ModSpells.GROWTH_INFUSION_INTERVAL, ModSpells.GROWTH_INFUSION_BONE_MEAL_COUNT, ModSpells.GROWTH_INFUSION_BONE_MEAL_COOLDOWN)
          .build()
      ));
  ...
  public static final PropertyHolder<Property.IntegerProperty> GROWTH_INFUSION_BONE_MEAL_COUNT = P.recordProperty("growth_infusion/bone_meal_count", Property.ofInt(5, "The number of stacks of bone meal to be applied per cast when then Fertilization modifier is active."));
  public static final PropertyHolder<Property.IntegerProperty> GROWTH_INFUSION_BONE_MEAL_COOLDOWN = P.recordProperty("growth_infusion/bone_meal_cooldown", Property.ofInt(5 * 20, SpellProperties.COOLDOWN));
  ...
  public static final DeferredHolder<Spell, RampantGrowthSpell> RAMPANT_GROWTH = REGISTER.register(Spells.RAMPANT_GROWTH.location()
      .getPath(), () ->
      new RampantGrowthSpell(new Spell.Properties(Spells.RAMPANT_GROWTH)
          .type(SpellType.Cast.CONTINUOUS)
          .charge(SpellType.Charge.OPERATION)
          .color(0x157318, 0x13c3eb)
  ...
  public static final DeferredHolder<Spell, HarvestSpell> HARVEST = REGISTER.register(Spells.HARVEST.location()
      .getPath(), () -> new HarvestSpell(new Spell.Properties(Spells.HARVEST)
      .operations()
      .textColor(ChatFormatting.YELLOW)
  ...
  public static final DeferredHolder<Spell, LifeDrainSpell> LIFE_DRAIN = REGISTER.register(Spells.LIFE_DRAIN.location()
      .getPath(), () -> new LifeDrainSpell(new Spell.Properties(Spells.LIFE_DRAIN)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
  ...
  public static final DeferredHolder<Spell, PetalShellSpell> PETAL_SHELL = REGISTER.register(Spells.PETAL_SHELL.location()
      .getPath(), () -> new PetalShellSpell(new Spell.Properties(Spells.PETAL_SHELL)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
      .textColor(ChatFormatting.LIGHT_PURPLE)
...
/*  public static final DeferredHolder<Spell, RadianceSpell> RADIANCE = spell(Spells.RADIANCE, RadianceSpell::new, ChatFormatting.GOLD, () -> CostInstance.of(Cost.add(ModHerbs.INFERNO_BULB, SpellCosts.BASE_0250), Cost.add(ModHerbs.CLOUD_BERRY, SpellCosts.BASE_0250)));
  ...
  public static final DeferredHolder<Spell, RoseThornsSpell> ROSE_THORNS = REGISTER.register(Spells.ROSE_THORNS.location()
      .getPath(), () -> new RoseThornsSpell(new Spell.Properties(Spells.ROSE_THORNS)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
...
/*  // Sanctuary (20 cooldown)
  ...
  public static final DeferredHolder<Spell, ShatterSpell> SHATTER = REGISTER.register(Spells.SHATTER.location()
      .getPath(), () -> new ShatterSpell(new Spell.Properties(Spells.SHATTER)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.OPERATION)
  ...
  public static final DeferredHolder<Spell, JauntSpell> JAUNT = REGISTER.register(Spells.JAUNT.location()
      .getPath(), () -> new JauntSpell(new Spell.Properties(Spells.JAUNT)
...
/*  public static final DeferredHolder<Spell, StormCloudSpell> STORM_CLOUD = spell(Spells.STORM_CLOUD, StormCloudSpell::new, ChatFormatting.DARK_BLUE, () -> CostInstance.of(Cost.add(ModHerbs.DEWGONIA, SpellCosts.BASE_0250), Cost.add(ModHerbs.CLOUD_BERRY, SpellCosts.BASE_0250)));
  ...
  public static final DeferredHolder<Spell, SkySoarerSpell> SKY_SOARER = REGISTER.register(Spells.SKY_SOARER.location()
      .getPath(), () -> new SkySoarerSpell(new Spell.Properties(Spells.SKY_SOARER)
      .type(SpellType.Cast.INSTANT)
      .charge(SpellType.Charge.INSTANCE)
      .textColor(ChatFormatting.BLUE)
