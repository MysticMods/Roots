...
import mysticmods.roots.recipe.fey.GroveCrafting;
...
public class ResolvedRecipes {
  ...
  public static final ResolvingRecipeType<PyreCrafting, PyreRitual> PYRE = new ResolvingRecipeType<>(new LazySupplier<>(() -> ModRecipes.Types.PYRE), Comparator.comparing(o -> o.getId().getPath()));
