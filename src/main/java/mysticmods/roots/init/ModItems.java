...
public class ModItems {
  ...
  public static DeferredHolder<Item, BlockItem> ENCHANTED_TURF = ITEMS.register("enchanted_turf", () -> new EnchantedTurfBlockItem(ModBlocks.ENCHANTED_TURF.get(), new Item.Properties()));
  // TODO: Contents
