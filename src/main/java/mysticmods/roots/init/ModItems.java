...
public class ModItems {
  ...
  /*  public static DeferredHolder<Item, BlockItem> GROWTH_AMPLIFIER = ITEMS.register("growth_amplifier", () -> new BlockItem(ModBlocks.GROWTH_AMPLIFIER.get(), new Item.Properties().cycleComponent(DataComponents.CONTAINER, ItemContainerContents.EMPTY)));*/
