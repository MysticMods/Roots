...
public class ModItems {
  ...
  public static DeferredHolder<Item, DeferredSpawnEggItem> SNOW_SPROUT_SPAWN_EGG = ITEMS.register("snow_sprout_spawn_egg", () -> new DeferredSpawnEggItem(ModEntities.SNOW_SPROUT, 0xfffffe, 0xd1eaeb, new Item.Properties()));
