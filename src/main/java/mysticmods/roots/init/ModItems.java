...
public class ModItems {
  ...
  public static final DeferredHolder<Item, CastingItem> STAFF = ITEMS.register("staff", () -> new CastingItem(new Item.Properties().component(ModAttachments.CURRENT_SLOT, 0).component(ModAttachments.SPELL_STORAGE, SpellStorage.EMPTY).stacksTo(1)));
  // TODO: Durability?
