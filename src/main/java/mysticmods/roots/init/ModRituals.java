...
public class ModRituals {
  ...
  public static final PropertyHolder<Property.IntegerProperty> ANIMAL_HARVEST_MAX_TRIES = P.recordProperty("animal_harvest/max_tries", Property.ofInt(20, "The maximum number of attempts per ritual operation to generate loot up to the `count` maximum number of entities, if the chosen entity produces no loot."));
