...
public class ModRituals {
  ...
  public static final DeferredHolder<Ritual, EmptyRitual> EMPTY = RITUAL.register("empty", EmptyRitual::new);
  public static final PropertyHolder<Property.IntegerProperty> EMPTY_DURATION = P.recordProperty("empty/duration", Property.ofInt(0, RitualProperties.DURATION + " (this ritual is unused"));
  public static final PropertyHolder<Property.IntegerProperty> EMPTY_INTERVAL = P.recordProperty("empty/interval", Property.ofInt(1, RitualProperties.INTERVAL + " (this ritual is unused"));
  ...
  public static final PropertyHolder<Property.IntegerProperty> ANIMAL_HARVEST_MAX_TRIES = P.recordProperty("animal_harvest/max_tries", Property.ofInt(8, "The maximum number of attempts per ritual operation to generate loot up to the `count` maximum number of entities, if the chosen entity produces no loot."));
  ...
  public static final PropertyHolder<Property.IntegerProperty> AUGMENTATION_DURATION = P.recordProperty("augmentation/duration", Property.ofInt(20, RitualProperties.DURATION));
  public static final PropertyHolder<Property.IntegerProperty> AUGMENTATION_INTERVAL = P.recordProperty("augmentation/interval", Property.ofInt(19, RitualProperties.INTERVAL));
