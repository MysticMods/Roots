...
public class ModFeatures {
  ...
  private static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = DeferredRegister.create(Registries.CONFIGURED_FEATURE, RootsAPI.MODID);
  private static final DeferredRegister<PlacedFeature> PLACED_FEATURES = DeferredRegister.create(Registries.PLACED_FEATURE, RootsAPI.MODID);
  ...
  public static final DeferredHolder<ConfiguredFeature<?, ?>, ConfiguredFeature<TreeConfiguration, ?>> WILDWOOD_TREE = CONFIGURED_FEATURES.register("wildwood_tree", () -> new ConfiguredFeature<>(Feature.TREE, createWildwood().build()));

   public static final DeferredHolder<ConfiguredFeature<?, ?>, ConfiguredFeature<TreeConfiguration, ?>> WILDWOOD_TREE_BEES = CONFIGURED_FEATURES.register("wildwood_tree_bees", () -> new ConfiguredFeature<>(Feature.TREE, createWildwood().decorators(List.of(new BeehiveDecorator(1.0F))).build()));

  // Place features
  public static DeferredHolder<PlacedFeature, PlacedFeature> WILD_ROOTS_UNDERGROUND_PLACED_FEATURE = PLACED_FEATURES.register("wild_roots_underground", () -> new PlacedFeature(Holder.direct(WILD_ROOTS_CONFIGURED_FEATURE.get()), List.of(
  ...
  public static DeferredHolder<PlacedFeature, PlacedFeature> WILD_ROOTS_FOREST_PLACED_FEATURE = PLACED_FEATURES.register("wild_roots_forest", () -> new PlacedFeature(Holder.direct(WILD_ROOTS_CONFIGURED_FEATURE.get()), List.of(
    BiomeFilter.biome(),
