...
public class ModConditions {
  ...
  public static final Supplier<IPlayerCondition> WILD_RANK_1 = Suppliers.memoize(() -> new GroveRankReputation(ModGroves.WILD.get(), 1));
  ...
  public static final Supplier<IPlayerCondition> WILD_RANK_2 = Suppliers.memoize(() -> new GroveRankReputation(ModGroves.WILD.get(), 2));
  ...
  public static final Supplier<IPlayerCondition> WILD_RANK_3 = Suppliers.memoize(() -> new GroveRankReputation(ModGroves.WILD.get(), 3));
  ...
  public static final Supplier<IPlayerCondition> WILD_RANK_4 = Suppliers.memoize(() -> new GroveRankReputation(ModGroves.WILD.get(), 4));
