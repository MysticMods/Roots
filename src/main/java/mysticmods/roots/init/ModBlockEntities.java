...
public class ModBlockEntities {
  ...
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<LimitedPedestalBlockEntity>> LIMITED_PEDESTAL = BLOCK_ENTITIES.register("limited_pedestal", () -> BlockEntityType.Builder.of(LimitedPedestalBlockEntity::new, ModBlocks.GROVE_PEDESTAL.get(), ModBlocks.DISPLAY_PEDESTAL.get()).build(null));
  public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PedestalBlockEntity>> PEDESTAL = BLOCK_ENTITIES.register("pedestal", () -> BlockEntityType.Builder.of(PedestalBlockEntity::new, ModBlocks.RITUAL_PEDESTAL.get(), ModBlocks.WILDWOOD_PEDESTAL.get(), ModBlocks.REINFORCED_RITUAL_PEDESTAL.get()).build(null));
