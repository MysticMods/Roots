...
public class ModContainers {
  ...
  public static final DeferredHolder<MenuType<?>, MenuType<GroveContainer>> GROVE = REGISTER.register("grove", () -> IMenuTypeExtension.create(GroveContainer::new));
  public static final DeferredHolder<MenuType<?>, MenuType<TransmuterContainer>> TRANSMUTER = REGISTER.register("transmuter", () -> IMenuTypeExtension.create(TransmuterContainer::new));
