...
public record UniqueReputation(ResourceLocation grove, ResourceLocation id) {
  ...
  public static final Codec<Set<UniqueReputation>> SET_CODEC = CODEC.listOf()
  ...
  public static final StreamCodec<FriendlyByteBuf, Set<UniqueReputation>> SET_STREAM_CODEC = UniqueReputation.STREAM_CODEC.apply(ByteBufCodecs.list())
      .map(ObjectOpenHashSet::new, ArrayList::new);
}
