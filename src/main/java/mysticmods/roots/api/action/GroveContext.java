...
public class GroveContext {
  private final ServerLevel level;
  private final Map<GroveParameter<?>, Object> params;

  public GroveContext(ServerLevel level, Map<GroveParameter<?>, Object> params) {
    this.level = level;
    this.params = params;
  }
...
/*    public <T> T getParameter(GroveParameter<T> parameter) {
    ...
    public GroveContext create(GroveParameterSet params) {
      ...
      if (!set.isEmpty()) {
        ...
        if (!set1.isEmpty()) {
          ...
          return new GroveContext(this.level, this.params);
        }
      }
    }
  }
