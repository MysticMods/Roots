...
public interface Shapes {
  ...
  VoxelShape CATALYST_PLATE = VoxelUtil.multiOr(Block.box(3, 2, 3,13, 4, 13), Block.box(3, 13, 3,13, 15, 13), Block.box(3, 4, 6,6, 13, 10), Block.box(10, 4, 6,13, 13, 10), Block.box(6, 4, 3,10, 13, 6), Block.box(6, 4, 10,10, 13, 13), Block.box(2, 0, 2,14, 2, 14), Block.box(2, 15, 2,14, 17, 14));
  ...
  VoxelShape INCENSE_PLATE = VoxelUtil.multiOr(Block.box(3, 2, 3,13, 4, 13), Block.box(3, 13, 3,13, 15, 13), Block.box(3, 4, 6,6, 13, 10), Block.box(10, 4, 6,13, 13, 10), Block.box(6, 4, 3,10, 13, 6), Block.box(6, 4, 10,10, 13, 13), Block.box(2, 0, 2,14, 2, 14), Block.box(2, 15, 2,14, 17, 5), Block.box(2, 15, 11,14, 17, 14), Block.box(2, 15, 5,5, 17, 11), Block.box(11, 15, 5,14, 17, 11), Block.box(5, 15, 5,11, 15.5, 11));
