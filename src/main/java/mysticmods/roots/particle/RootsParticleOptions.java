...
public record RootsParticleOptions(ParticleType<?> type, int color1, int color2,
  ...
  public static MapCodec<RootsParticleOptions> codec(ParticleType<?> type) {
    ...
    ).apply(instance, (a, b, c) -> new RootsParticleOptions(type, a, b, c)));
  }
