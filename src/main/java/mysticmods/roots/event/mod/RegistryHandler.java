...
public class RegistryHandler {
  ...
  public static final ResourceLocation RITUAL_REGISTRY = new ResourceLocation(RootsAPI.MODID, "rituals");

  @SuppressWarnings("unchecked")
  @SubscribeEvent
  public static void onRegistryCreation(NewRegistryEvent event) {
    event.create(makeRegistry(HERB_REGISTRY, Herb.class), (registry) -> ModRegistries.HERB_REGISTRY = registry);
    event.create(makeRegistry(RITUAL_REGISTRY, Ritual.class), (registry) -> ModRegistries.RITUAL_REGISTRY = registry);
  }
