...
public class FrostLandsRitual extends Ritual {
  ...
  protected RitualProperty<Integer> getDurationProperty() {
    return ModRituals.FROST_LANDS_DURATION.get();
  }

  @Override
  protected RitualProperty<Integer> getRadiusXZProperty() {
    return ModRituals.FROST_LANDS_RADIUS_XZ.get();
  }

  @Override
  protected RitualProperty<Integer> getRadiusYProperty() {
    return ModRituals.FROST_LANDS_RADIUS_Y.get();
  }

  @Override
  protected RitualProperty<Integer> getIntervalProperty() {
    return ModRituals.FROST_LANDS_INTERVAL.get();
  }
}
