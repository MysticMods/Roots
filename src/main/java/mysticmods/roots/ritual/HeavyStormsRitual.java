...
public class HeavyStormsRitual extends Ritual {
  ...
  protected RitualProperty<Integer> getDurationProperty() {
    return ModRituals.HEAVY_STORMS_DURATION.get();
  }

  @Override
  protected RitualProperty<Integer> getRadiusXZProperty() {
    return ModRituals.HEAVY_STORMS_RADIUS_XZ.get();
  }

  @Override
  protected RitualProperty<Integer> getRadiusYProperty() {
    return ModRituals.HEAVY_STORMS_RADIUS_Y.get();
  }

  @Override
  protected RitualProperty<Integer> getIntervalProperty() {
    return ModRituals.HEAVY_STORMS_INTERVAL.get();
  }
}
