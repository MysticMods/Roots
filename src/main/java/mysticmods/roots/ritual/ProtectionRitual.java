...
public class ProtectionRitual extends Ritual {
  ...
  protected RitualProperty<Integer> getDurationProperty() {
    return ModRituals.PROTECTION_DURATION.get();
  }

  @Override
  protected RitualProperty<Integer> getRadiusXZProperty() {
    return ModRituals.PROTECTION_RADIUS_XZ.get();
  }

  @Override
  protected RitualProperty<Integer> getRadiusYProperty() {
    return ModRituals.PROTECTION_RADIUS_Y.get();
  }

  @Override
  protected RitualProperty<Integer> getIntervalProperty() {
    return ModRituals.PROTECTION_INTERVAL.get();
  }
}
