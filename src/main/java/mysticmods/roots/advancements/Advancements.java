...
public class Advancements {
  ...
  public static final ResourceLocation ACTIVATE_ID = new ResourceLocation(RootsAPI.MODID, "grove_activate");
  public static final ResourceLocation CRAFTING_ID = new ResourceLocation(RootsAPI.MODID, "fey_crafting");
  public static final ResourceLocation MODIFIER_ID = new ResourceLocation(RootsAPI.MODID, "modifier");
